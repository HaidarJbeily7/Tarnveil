  ...
  projects: [
    {
      ...
      testMatch: /(?:title\.default|chop|gallery|landing|connect|character|toasts|hud|inventory|skills|chat-panel|combat|quests|market|bank|friends|settings-tabs|loading)\.spec\.ts/,
    },
    {
      name: "branded",
